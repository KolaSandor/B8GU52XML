...
public class DomModifyB8GU52_1 {

    public static void main(String[] args) {
        try {
 
            File xmlFile = new File("C:\\Users\\Kola Sándor\\Desktop\\XML\\1105\\orarendB8GU52.xml");
            ...
            StreamResult fileResult = new StreamResult(new FileOutputStream("orarendModifyB8GU52.xml"));
            transformer.transform(source, fileResult);

            System.out.println("A módosított fájl mentve: orarendModifyB8GU52.xml");
